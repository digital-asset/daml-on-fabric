...
declare -a auths_certs=("--auth-jwt-rs256-crt=./data/ledger_certs/rs256_jwt_token.crt" "--auth-jwt-es256-crt=./data/ledger_certs/es256_jwt_token.crt" "--auth-jwt-es512-crt=./data/ledger_certs/es512_jwt_token.crt" "--auth-jwt-hs256-unsafe=someunsafesecret" "--auth-jwt-rs256-jwks=http://jwt-provider:8088")
